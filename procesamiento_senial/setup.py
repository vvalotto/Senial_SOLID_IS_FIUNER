...
README = README_PATH.read_text(encoding="utf-8") if README_PATH.exists() else "Procesadores de señales digitales"

setup(
    name="procesamiento-senial",
    version="3.0.0",
    description="Procesadores de señales (amplificador, umbral) y FactoryProcesador",
